                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-group label-floating">
                                        {{-- <iframe src="{{ asset($finish->exerciseFinish) }}" frameborder="0" width="100%" height="300px"></iframe> --}}
                                        <div class="alert col-md-12" data-notify="container">
                                            <button type="button" class="close">
                                                <a href="{{ asset($finish->exerciseFinish) }}" download>
                                                    <i class="material-icons" style="color: black; size: 100px">
                                                        get_app   
                                                    </i>
                                                </a>
                                            </button>
                                            <span id="fileFinish">{{ basename($finish->exerciseFinish).PHP_EOL }}</span>
                                        </div>
                                    </div>      
                                </div>
                            </div>
