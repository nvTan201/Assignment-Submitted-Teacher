...
<div class="col-sm-10 col-lg-2 text-right">
    <div class="dropdown text-right">
        <button href="" class="dropdown-toggle btn btn-primary btn-round btn-block" data-toggle="dropdown" style="
    right: -360px;">Thêm Bài Tập
            <b class="caret"></b>       
        </button>
...
@include('exercise.update') 
@include('exercise.createFile')
@include('exercise.updateFile')
